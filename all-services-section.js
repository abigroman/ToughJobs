...
(function () {
  ...
  var css = ''
    + '#all-services-section{background:#0A0F1C;color:#fff;padding:72px 0;position:relative;overflow:hidden;'
    +   'background-image:radial-gradient(circle at 1px 1px,rgba(199,203,210,.16) 1.2px,transparent 1.4px);background-size:24px 24px}'
    ...
    + '#all-services-section .as-sub{max-width:52ch;font-size:16px;line-height:1.6;color:#C7CBD2;margin:0 0 4px}'
    ...
    +   'background:#fff;color:#0A0F1C;text-decoration:none;overflow:hidden;transition:transform .18s cubic-bezier(.22,.9,.3,1),box-shadow .18s ease,background-color .18s ease}'
    ...
    + '#all-services-section .as-card:hover{transform:translateY(-3px);background:#F4F5F7;box-shadow:0 14px 28px rgba(0,0,0,.26)}'
