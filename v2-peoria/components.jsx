...
// ── Service icon set ───────────────────────────────────────────────────────
// Metallic/futuristic icons — 36×36, thin strokes, geometric, with subtle
// inner glow effects via gradients and layered shapes.
function ServiceIcon({ icon, color = "currentColor" }) {
  const icons = {
    websites: (
      <svg viewBox="0 0 36 36" width="36" height="36" fill="none" aria-hidden="true">
        ...
        <rect x="3" y="6" width="30" height="24" rx="1.5" stroke={color} strokeWidth="1.2" />
        <line x1="3" y1="12" x2="33" y2="12" stroke={color} strokeWidth="1.2" />
        <circle cx="7" cy="9" r="0.8" fill="url(#webGrad)" />
        <circle cx="10" cy="9" r="0.8" fill="url(#webGrad)" />
        <circle cx="13" cy="9" r="0.8" fill="url(#webGrad)" />
        <rect x="6" y="16" width="12" height="1.5" rx="0.5" fill={color} opacity="0.4" />
        <rect x="6" y="20" width="18" height="1.5" rx="0.5" fill={color} opacity="0.4" />
        <rect x="6" y="24" width="14" height="1.5" rx="0.5" fill={color} opacity="0.4" />
      </svg>
    ),
    seo: (
      <svg viewBox="0 0 36 36" width="36" height="36" fill="none" aria-hidden="true">
        <defs>
          <radialGradient id="seoGrad">
            <stop offset="0%" stopColor={color} stopOpacity="0.6" />
            <stop offset="100%" stopColor={color} stopOpacity="0" />
          </radialGradient>
        </defs>
        <circle cx="15" cy="15" r="9" stroke={color} strokeWidth="1.2" />
        <circle cx="15" cy="15" r="5" fill="url(#seoGrad)" />
        <line x1="22" y1="22" x2="31" y2="31" stroke={color} strokeWidth="2" strokeLinecap="round" />
        <line x1="11" y1="18" x2="11" y2="15" stroke={color} strokeWidth="1.2" strokeLinecap="round" />
        <line x1="15" y1="18" x2="15" y2="12" stroke={color} strokeWidth="1.2" strokeLinecap="round" />
        <line x1="19" y1="18" x2="19" y2="10" stroke={color} strokeWidth="1.2" strokeLinecap="round" />
      </svg>
    ),
    paid: (
      <svg viewBox="0 0 36 36" width="36" height="36" fill="none" aria-hidden="true">
        <defs>
          <radialGradient id="paidGrad">
            <stop offset="20%" stopColor={color} stopOpacity="0.8" />
            <stop offset="100%" stopColor={color} stopOpacity="0" />
          </radialGradient>
        </defs>
        <circle cx="18" cy="18" r="14" stroke={color} strokeWidth="1.2" />
        <circle cx="18" cy="18" r="8" stroke={color} strokeWidth="1.2" />
        <circle cx="18" cy="18" r="12" fill="url(#paidGrad)" />
        <circle cx="18" cy="18" r="2" fill={color} />
        <line x1="18" y1="2" x2="18" y2="6" stroke={color} strokeWidth="1.2" strokeLinecap="round" />
        <line x1="18" y1="30" x2="18" y2="34" stroke={color} strokeWidth="1.2" strokeLinecap="round" />
        <line x1="2" y1="18" x2="6" y2="18" stroke={color} strokeWidth="1.2" strokeLinecap="round" />
        <line x1="30" y1="18" x2="34" y2="18" stroke={color} strokeWidth="1.2" strokeLinecap="round" />
      </svg>
    ),
    branding: (
      <svg viewBox="0 0 36 36" width="36" height="36" fill="none" aria-hidden="true">
        ...
        <path d="M 20 3 L 8 19 L 16 19 L 14 33 L 28 15 L 19 15 L 20 3 Z"
              stroke={color} strokeWidth="1.2" strokeLinejoin="miter" fill="url(#brandGrad)" />
      </svg>
    ),
  };
...
function Services() {
  ...
  return (
    ...
    <section data-component="Services" data-screen-label="02 Services" style={{
      ...
      {/* Red tilted divider at bottom — 40px max, uniform tilt */}
      <div aria-hidden="true" style={{
        position: "absolute", bottom: 0, left: 0, right: 0, height: 40,
        background: "var(--accent)",
        clipPath: "polygon(0 0, 100% calc(100% - 40px), 100% 100%, 0 100%)",
        zIndex: 1,
      }} />
      ...
      <div className="container" style={{ position: "relative", zIndex: 2 }}>
        ...
        <div style={{
          ...
          {/* Engineering schematic background — 50% opacity, spans the entire 4-card grid */}
          <div aria-hidden="true" style={{
            position: "absolute", inset: 0,
            backgroundImage: "url(assets/engineering-schematics.png)",
...
function ServiceCard({ item }) {
  ...
  return (
    ...
    style={{
      position: "relative",
      background: hover ? "#000000" : "var(--accent)",
      color: hover ? "var(--white)" : "var(--accent-ink)",
      ...
      {/* Accent pill badge (top-left) — flips color on hover */}
      <span style={{
        position: "absolute", top: 18, left: 18,
        background: hover ? "var(--accent)" : "#000000",
        color: hover ? "var(--accent-ink)" : "var(--white)",
        fontFamily: '"Archivo",sans-serif', fontWeight: 800, fontSize: 12,
        letterSpacing: ".08em", padding: "4px 10px", borderRadius: 12,
        transition: "background .25s ease, color .25s ease",
        zIndex: 3
      }}>
        {n}
      ...
      <div style={{ padding: "52px 24px 0", flexShrink: 0, position: "relative", zIndex: 2 }}>
        <ServiceIcon icon={icon} color={hover ? "var(--white)" : "var(--accent-ink)"} />
      </div>

      {/* Content */}
      <div style={{ padding: "0 24px 32px", flex: 1, display: "flex", flexDirection: "column", gap: 14, position: "relative", zIndex: 2 }}>
        ...
        <p style={{
          fontSize: 15, lineHeight: 1.5, margin: 0, flex: 1,
          color: hover ? "rgba(255,255,255,.85)" : "rgba(10,15,28,.7)",
          transition: "color .25s ease"
        }}>
          {body}
        </p>
...
function Wraps() {
  ...
  return (
    <section data-component="Wraps" data-screen-label="03 Wraps" style={{ background:"var(--surface)", position:"relative" }} className="chev-bot">
      {/* Red diagonal divider at top — 40px max, uniform tilt */}
      <div aria-hidden="true" style={{
        position:"absolute", top:0, left:0, right:0, height:40,
        background:"var(--accent)",
        clipPath:"polygon(0 0, 100% 0, 100% 100%, 0 40px)",
        zIndex:0,
      }} />
...
function Statement() {
  return (
    <section data-component="Statement" data-screen-label="04 Statement" style={{
      ...
      {/* Black diagonal accent band at the top — 40px max, uniform tilt */}
      <div aria-hidden="true" style={{
        position: "absolute", top: 0, left: 0, right: 0, height: 40,
        background: "#000",
        clipPath: "polygon(0 0, 100% 0, 100% 100%, 0 40px)",
      ...
      {/* White diagonal wedge at the bottom — 40px max, uniform tilt */}
      <div aria-hidden="true" style={{
        position: "absolute", bottom: 0, left: 0, right: 0, height: 40,
