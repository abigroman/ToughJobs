...
export default function Page() {
  React.useEffect(() => {
    document.title = 'Toughjobs — Coaching Your Crew | More Reviews, More Calls';
  }, []);
...
<title>Toughjobs — Coaching Your Crew | More Reviews, More Calls</title>
...
<style>
  *,*::before,*::after{box-sizing:border-box}
  ...
  .hero-inner{position:relative;padding:120px 0 85px}
  ...
  footer{background:var(--ink);color:var(--white);padding:38px 0;text-align:center}
...
<section class="hero">
  <div class="hero-inner">
    ...
    <div class="ghost-word">COACH</div>
    <div class="container">
      <span class="eyebrow rise d1">Team Coaching · Reviews &amp; Calls</span>
      <h1 class="display rise d2">Your crew is your <span class="r">best marketing.</span></h1>
      <p class="rise d3">Ads get the phone to ring. Your people decide whether it becomes a booked job, a five-star review, and the next referral. Here's how to coach them to do exactly that — without spending another dollar on advertising.</p>
    </div>
  </div>
</section>
...
<section class="block on-light textured">
  ...
  <div class="container">
    <div class="why-grid reveal">
      <div>
        <div class="sec-eyebrow">Why Coaching</div>
        <h2 class="display sec-title">The work is only<br />half the job.</h2>
        <p class="sec-sub">A flawless install with a rude tech and no review request still costs you the next ten jobs. Coaching turns every visit into reviews, repeat calls, and referrals — compounding the marketing you're already paying for.</p>
      </div>
      <figure class="growth-fig">
        <div class="gf-tag">FIG. 01 — THE COMPOUNDING EFFECT</div>
        <h4>Same ad budget. Two crews.</h4>
        <p class="sub">Booked jobs per month over a year</p>
        <svg viewBox="0 0 460 240" role="img" aria-label="Growth curve: a coached crew compounds booked jobs over 12 months while an uncoached crew stays flat">
          <!-- grid -->
          <g stroke="rgba(255,255,255,.10)" stroke-width="1">
            <line x1="40" y1="20" x2="40" y2="200"/>
            <line x1="40" y1="200" x2="450" y2="200"/>
            <line x1="40" y1="155" x2="450" y2="155" stroke-dasharray="3 5"/>
            <line x1="40" y1="110" x2="450" y2="110" stroke-dasharray="3 5"/>
            <line x1="40" y1="65" x2="450" y2="65" stroke-dasharray="3 5"/>
          </g>
          <!-- uncoached: flat -->
          <path d="M40 168 L450 162" fill="none" stroke="#7DA8FF" stroke-width="3" stroke-linecap="round" class="gf-line" style="stroke-dasharray:430;stroke-dashoffset:430"/>
          <!-- coached: compounding J-curve -->
          <path d="M40 168 C 170 165, 250 140, 320 95 S 410 35, 450 22" fill="none" stroke="#C8262A" stroke-width="4" stroke-linecap="round" class="gf-line" style="stroke-dasharray:520;stroke-dashoffset:520;animation-duration:2s"/>
          <!-- end dots -->
          <circle cx="450" cy="22" r="5" fill="#C8262A"/>
          <circle cx="450" cy="162" r="4" fill="#7DA8FF"/>
          <!-- axis labels -->
          <text x="40" y="218" fill="rgba(255,255,255,.55)" font-family="Archivo, sans-serif" font-size="11" font-weight="700">Month 1</text>
          <text x="450" y="218" fill="rgba(255,255,255,.55)" font-family="Archivo, sans-serif" font-size="11" font-weight="700" text-anchor="end">Month 12</text>
        </svg>
        <div class="gf-legend">
          <span><i style="background:#C8262A"></i>Coached crew</span>
          <span><i style="background:#7DA8FF"></i>No coaching</span>
        </div>
      </figure>
    </div>
    <div class="reasons reveal">
      <div class="reason"><div class="rn">01</div><h3>Reviews Build Trust</h3><p>Nearly 9 in 10 customers read reviews before they call. More five-star reviews mean more people pick up the phone in the first place.</p></div>
      <div class="reason"><div class="rn">02</div><h3>Calls Become Jobs</h3><p>How the phone is answered decides whether a lead books or dials your competitor. The script matters as much as the ad that drove the call.</p></div>
      <div class="reason"><div class="rn">03</div><h3>Your Team Controls Both</h3><p>The tech at the door and the voice on the phone are your real marketing department. Coach them and everything else compounds.</p></div>
    </div>
  </div>
</section>
  ...
  <div class="container" style="position:relative;z-index:2">
    <div class="pillar reveal">
      <div class="pillar-copy">
        <div class="pillar-num"><span class="pn">01</span> Coach for Reviews</div>
        <h2 class="display">Get more<br />5-star reviews.</h2>
        <p class="lede">Most happy customers never leave a review — not because they won't, but because nobody asked at the right moment. Train your team to ask every time, the easy way.</p>
        <div class="script-box">
          <div class="sl">The on-site ask</div>
          <div class="quote">“If you were happy with the work today, the best thing you can do for us is a quick Google review — I'll text you the link right now.”</div>
        </div>
      </div>
      <ul class="tactics">
        <li><div class="ti">1</div><div><p class="tt">Ask at the peak moment</p><p class="td">Right after the job's done and the customer is smiling — not days later by email.</p></div></li>
        <li><div class="ti">2</div><div><p class="tt">Make it one tap</p><p class="td">Text the review link or show a QR code on the spot. Every extra step loses reviews.</p></div></li>
        <li><div class="ti">3</div><div><p class="tt">Name the platform</p><p class="td">“A Google review” beats “a review.” Tell them exactly where to go.</p></div></li>
        <li><div class="ti">4</div><div><p class="tt">Reward the ask, not the rating</p><p class="td">Bonus techs for review requests sent — never for stars. It keeps things honest and within Google's rules.</p></div></li>
        <li><div class="ti">5</div><div><p class="tt">Reply to every review</p><p class="td">Thank the good ones, calmly fix the bad ones in public. It shows future customers you care.</p></div></li>
      </ul>
    </div>
  </div>
</section>
...
<section class="block on-light textured">
  ...
  <div class="container">
    <div class="pillar flip reveal">
      <div class="pillar-copy">
        <div class="pillar-num"><span class="pn">02</span> Coach for Calls</div>
        <h2 class="display">Turn more calls<br />into booked jobs.</h2>
        <p class="lede">A ringing phone is wasted if it goes to voicemail or a flat “we'll call you back.” Coach the people answering to win the job in the first two minutes.</p>
        <div class="script-box">
          <div class="sl">The phone greeting</div>
          <div class="quote">“Thanks for calling Toughjobs, this is Mike — how can I help you today?” Warm, named, and ready to book.</div>
        </div>
      </div>
      <ul class="tactics">
        <li><div class="ti">1</div><div><p class="tt">Answer every call live</p><p class="td">A missed call is a lost job — they dial the next name on the list. Build a rotation so it never rings out.</p></div></li>
        <li><div class="ti">2</div><div><p class="tt">Win the first 10 seconds</p><p class="td">A warm, confident greeting with your company name sets the tone for the whole call.</p></div></li>
        <li><div class="ti">3</div><div><p class="tt">Book, don't quote-and-hope</p><p class="td">Coach staff to schedule the visit on the first call instead of promising to “get back to them.”</p></div></li>
        <li><div class="ti">4</div><div><p class="tt">Look the part on site</p><p class="td">Uniforms, clean trucks, a real introduction. Professional crews get referred and re-hired.</p></div></li>
        <li><div class="ti">5</div><div><p class="tt">Leave the door open</p><p class="td">Train techs to mention your other services and leave a card or fridge magnet behind.</p></div></li>
      </ul>
    </div>
  </div>
</section>
...
<section class="cta">
  ...
  <div class="container">
    <div class="reveal">
      <h2 class="display">We'll coach your crew with you.</h2>
      <p>Toughjobs builds the review system, the call scripts, and the simple training that turns your team into your best marketing channel.</p>
      <a href="contact.html" class="btn">Talk Coaching →</a>
    </div>
  </div>
</section>
