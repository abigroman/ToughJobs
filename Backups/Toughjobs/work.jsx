...
export default function Page() {
  React.useEffect(() => {
    document.title = 'Work — Toughjobs | Marketing for the Trades | Peoria, IL';
  }, []);
...
<title>Work — Toughjobs | Marketing for the Trades | Peoria, IL</title>
...
<script type="text/babel" src="work-app.jsx?v=2"></script>
