...
export default function Page() {
  React.useEffect(() => {
    document.title = 'Contact — Toughjobs | Marketing for the Trades | Peoria, IL';
  }, []);
...
<title>Contact — Toughjobs | Marketing for the Trades | Peoria, IL</title>


<link href="https://fonts.googleapis.com/css2?family=Archivo+Black&family=Archivo:wght@400;500;600;700;800;900&family=Inter:wght@400;500;600;700&family=Oswald:wght@200;300;400;500;600;700&family=Orbitron:wght@600;700;800;900&family=Russo+One&display=swap" rel="stylesheet" />
<style>
...
<script type="text/babel" src="contact-app.jsx"></script>

<script src="accessibility.js"></script>
<script src="sticky-cta.js"></script>

<script type="text/babel">
// Tweaks for contact page
function ContactTweaks() {
  const [paragraphFont, setParagraphFont] = React.useState('Inter');
  ...
  React.useEffect(() => {
    ...
    document.querySelectorAll('p').forEach(p => {
      p.style.fontFamily = fontMap[paragraphFont];
    });
  }, [paragraphFont]);
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 12, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 16, color: 'var(--ink)' }}>Paragraph Font</div>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        {['Inter', 'Oswald', 'Archivo'].map(font => (
          <label key={font} style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer', fontSize: 14 }}>
            <input
              type="radio"
              name="paragraphFont"
              value={font}
              checked={paragraphFont === font}
