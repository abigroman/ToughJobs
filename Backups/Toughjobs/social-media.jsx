...
export default function Page() {
  React.useEffect(() => {
    document.title = 'Toughjobs — Social Media | Build Community, Not Just Posts';
  }, []);
...
<title>Toughjobs — Social Media | Build Community, Not Just Posts</title>
...
<main>
  ...
  <section class="bg-dark hero">
    ...
    <div class="container">
      <span class="eyebrow accent reveal">Social that builds trust</span>
      <h1 class="display reveal d1">Stay top of mind<br>for the <span class="accent2c">midnight</span> AC call.</h1>
      <p class="lede reveal d2">Most agencies post and ghost. We build real engagement — content in your voice, posted consistently — so when something breaks, you're the name they already know and trust.</p>
      <div class="reveal d3"><a class="btn" href="contact.html">Book a free strategy call &rarr;</a></div>
      <div class="kpis"><div class="kpi reveal"><div class="num"><span data-count="5">0</span><span class="suf">×/wk</span></div><div class="lbl">Consistent, on-brand posting</div></div><div class="kpi reveal"><div class="num"><span data-count="3">0</span><span class="suf">×</span></div><div class="lbl">More trust from active vs. dead profiles</div></div><div class="kpi reveal"><div class="num"><span style="font-size:.55em;vertical-align:top">$</span><span data-count="0">0</span></div><div class="lbl">Spent on fake followers — ever</div></div></div>
    </div>
  </section>
  ...
  <section class="bg-light">
    ...
    <div class="container">
      <div class="head reveal">
        ...
        <h2 class="display">Real content. Real engagement. Real leads.</h2>
        <p class="lede">We handle execution so you stay on the truck.</p>
      </div>
      <div class="flow" style="--steps:4"><div class="step reveal d1"><div class="node">1</div><h4>Voice</h4><p>We define a content strategy that sounds like you, not a robot.</p></div><div class="step reveal d2"><div class="node">2</div><h4>Create</h4><p>We produce posts — or source authentic photos from your crew.</p></div><div class="step reveal d3"><div class="node">3</div><h4>Engage</h4><p>We respond to comments and DMs, building relationships that convert.</p></div><div class="step reveal d4"><div class="node">4</div><h4>Track</h4><p>We trace which posts drive calls and double down on what works.</p></div></div>
    </div>
  </section>
  ...
  <section class="bg-navy">
    ...
    <div class="container">
      <div class="head reveal">
        ...
        <h2 class="display">A following that calls when it counts.</h2>
      </div>
      <div class="earn"><div class="card reveal d1"><div class="ic">01</div><h4>Top-of-mind recall</h4><p>Consistent presence means you're the first call when something breaks.</p></div><div class="card reveal d2"><div class="ic">02</div><h4>Free word-of-mouth</h4><p>Shareable content turns happy customers into your sales team.</p></div><div class="card reveal d3"><div class="ic">03</div><h4>Cheaper than ads</h4><p>Organic reach builds an audience you don't pay per-click to reach again.</p></div></div>
    </div>
  </section>
  ...
  <section class="bg-light">
    ...
    <div class="container">
      <div class="head reveal">
        ...
        <p class="lede">Posting is easy. Results aren't.</p>
      </div>
      <div class="cmp-wrap reveal d1">
        <table class="cmp">
          ...
          <tbody><tr><td class="rowlbl">Monthly cost</td><td class="x">Your evenings</td><td>$1,000–3,000/mo</td><td class="tj">$600–1,800/mo</td></tr><tr><td class="rowlbl">Real engagement</td><td class="x">Sporadic</td><td>Scheduled & gone</td><td class="tj"><span class="yes">Active community mgmt</span></td></tr><tr><td class="rowlbl">Content creation</td><td class="x">You shoot it</td><td>Stock-heavy</td><td class="tj"><span class="yes">Authentic, your crew</span></td></tr><tr><td class="rowlbl">Leads traced to posts</td><td class="x">No</td><td>Rarely</td><td class="tj"><span class="yes">Yes</span></td></tr><tr><td class="rowlbl">Bought followers</td><td class="x">Tempting</td><td>Sometimes</td><td class="tj"><span class="yes">Never</span></td></tr></tbody>
        </table>
      </div>
      <p class="cmp-note">Followers don't pay invoices. Engaged neighbors who remember your name do.</p>
    </div>
  </section>
  ...
  <section class="bg-dark">
    ...
    <div class="container">
      <div class="head reveal">
        ...
        <h2 class="display">What staying top-of-mind is worth.</h2>
      ...
      <div class="roi reveal d1">
        <div class="controls">
          <div class="field">
            <label>Monthly profile reach (people) <span class="val" id="roi-driver-val"></span></label>
            <input type="range" id="roi-driver" min="300" max="12000" step="100" value="2500" />
          </div>
          <div class="field">
            <label>Average job value <span class="val" id="roi-job-val"></span></label>
            <input type="range" id="roi-job" min="100" max="5000" step="50" value="400" />
          </div>
  ...
  <section class="bg-light">
    ...
    <div class="container">
      ...
      <div class="tess"><div class="t reveal"><p class="q">&ldquo;People mention our posts when they call now. That never happened before.&rdquo;</p><div class="who"><div class="av">TG</div><div><div class="nm">Tony G.</div><div class="rl">Landscaping, Moline IL</div></div></div></div><div class="t reveal"><p class="q">&ldquo;They post like they've worked here for years. It actually sounds like us.&rdquo;</p><div class="who"><div class="av">RP</div><div><div class="nm">Rachel P.</div><div class="rl">Cleaning Co., Davenport IA</div></div></div></div></div>
    </div>
  </section>
  ...
  <section class="bg-accent2 ctaband">
    <div class="tex tex-grid"></div>
    <div class="container">
      <h2 class="display reveal">Become the name they remember.</h2>
      <p class="reveal d1">Book a free strategy call and we'll audit your current social presence and map a plan that turns followers into phone calls.</p>
...
<script>window.SERVICE_DATA={"roi":{"liftPct":0.015,"closeRate":0.3,"ourCost":900,"driverSuffix":""}};</script>
