...
export default function Page() {
  React.useEffect(() => {
    document.title = 'Toughjobs — Paid Ads | Ads That Respect Your Cost Per Lead';
  }, []);
...
<title>Toughjobs — Paid Ads | Ads That Respect Your Cost Per Lead</title>
...
<main>
  ...
  <section class="bg-dark hero">
    ...
    <div class="container">
      <span class="eyebrow accent reveal">Paid media that performs</span>
      <h1 class="display reveal d1">Ads that respect<br>your <span class="accent2c">cost per lead.</span></h1>
      <p class="lede reveal d2">We optimize keywords weekly, pause losers daily, and cap your spend at what you're comfortable with while we dial it in. Every dollar is tracked to a phone call — no vanity clicks.</p>
      <div class="reveal d3"><a class="btn" href="contact.html">Book a free strategy call &rarr;</a></div>
      <div class="kpis"><div class="kpi reveal"><div class="num"><span data-count="3">0</span></div><div class="lbl">Platforms: Google, Bing, Meta</div></div><div class="kpi reveal"><div class="num"><span data-count="20">0</span><span class="suf">%</span></div><div class="lbl">Cheaper clicks on Bing vs. Google</div></div><div class="kpi reveal"><div class="num"><span data-count="7">0</span><span class="suf"> days</span></div><div class="lbl">To first optimization pass</div></div></div>
    </div>
  </section>
  ...
  <section class="bg-light">
    ...
    <div class="container">
      <div class="head reveal">
        ...
        <h2 class="display">Tight campaigns, ruthless optimization.</h2>
        <p class="lede">We treat your budget like it's our own.</p>
      </div>
      <div class="flow" style="--steps:4"><div class="step reveal d1"><div class="node">1</div><h4>Setup</h4><p>High-intent keywords, geo-targeting, and conversion tracking wired in.</p></div><div class="step reveal d2"><div class="node">2</div><h4>Launch</h4><p>Start capped low. We prove it works before we scale spend.</p></div><div class="step reveal d3"><div class="node">3</div><h4>Optimize</h4><p>Pause underperformers daily, A/B test ad copy every two weeks.</p></div><div class="step reveal d4"><div class="node">4</div><h4>Scale</h4><p>Pour budget only into what's converting to phone calls.</p></div></div>
    </div>
  </section>
  ...
  <section class="bg-navy">
    ...
    <div class="container">
      <div class="head reveal">
        ...
        <h2 class="display">Leads on demand — without the waste.</h2>
      </div>
      <div class="earn"><div class="card reveal d1"><div class="ic">01</div><h4>Instant top placement</h4><p>Be at the top of Google for emergency searches the day we launch.</p></div><div class="card reveal d2"><div class="ic">02</div><h4>A controlled CPL</h4><p>We optimize to your cost-per-lead target, not a vanity click count.</p></div><div class="card reveal d3"><div class="ic">03</div><h4>No wasted spend</h4><p>Daily monitoring means your budget chases booked jobs, not ghosts.</p></div></div>
    </div>
  </section>
  ...
  <section class="bg-light">
    ...
    <div class="container">
      <div class="head reveal">
        ...
        <p class="lede">Most ad budgets leak. Ours don't.</p>
      </div>
      <div class="cmp-wrap reveal d1">
        <table class="cmp">
          ...
          <tbody><tr><td class="rowlbl">Management fee</td><td class="x">$0 (you guess)</td><td>15–20% of spend</td><td class="tj">Flat, transparent</td></tr><tr><td class="rowlbl">Optimization cadence</td><td class="x">Set & forget</td><td>Monthly</td><td class="tj"><span class="yes">Daily / weekly</span></td></tr><tr><td class="rowlbl">Conversion tracking</td><td class="x">Rarely set up</td><td>Sometimes</td><td class="tj"><span class="yes">Every campaign</span></td></tr><tr><td class="rowlbl">Wasted spend</td><td class="x">High</td><td>Medium</td><td class="tj"><span class="yes">Minimized</span></td></tr><tr><td class="rowlbl">Spend cap control</td><td class="x">Manual</td><td>Loose</td><td class="tj"><span class="yes">You set it</span></td></tr></tbody>
        </table>
      </div>
      <p class="cmp-note">A poorly managed campaign burns cash on the wrong clicks. Daily optimization is the whole game.</p>
    </div>
  </section>
  ...
  <section class="bg-dark">
    ...
    <div class="container">
      <div class="head reveal">
        ...
        <h2 class="display">What disciplined ads return.</h2>
      ...
      <div class="roi reveal d1">
        <div class="controls">
          <div class="field">
            <label>Monthly ad clicks <span class="val" id="roi-driver-val"></span></label>
            <input type="range" id="roi-driver" min="100" max="4000" step="25" value="600" />
          </div>
          <div class="field">
            <label>Average job value <span class="val" id="roi-job-val"></span></label>
            <input type="range" id="roi-job" min="100" max="5000" step="50" value="500" />
          </div>
  ...
  <section class="bg-light">
    ...
    <div class="container">
      ...
      <div class="tess"><div class="t reveal"><p class="q">&ldquo;Same budget, twice the calls after they took over. The waste was unreal before.&rdquo;</p><div class="who"><div class="av">SD</div><div><div class="nm">Sam D.</div><div class="rl">Garage Doors, Moline IL</div></div></div></div><div class="t reveal"><p class="q">&ldquo;They capped my spend until it worked, then scaled. Felt like a partner, not a vendor.&rdquo;</p><div class="who"><div class="av">LA</div><div><div class="nm">Luis A.</div><div class="rl">HVAC, East Moline IL</div></div></div></div></div>
    </div>
  </section>
  ...
  <section class="bg-accent2 ctaband">
    <div class="tex tex-grid"></div>
    <div class="container">
      <h2 class="display reveal">Stop burning ad budget.</h2>
      <p class="reveal d1">Book a free strategy call and we'll review your current campaigns (or build a plan from scratch) and show you where the money's leaking.</p>
...
<script>window.SERVICE_DATA={"roi":{"liftPct":0.08,"closeRate":0.3,"ourCost":800,"driverSuffix":""}};</script>
