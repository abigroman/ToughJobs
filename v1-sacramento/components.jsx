      ...
      <section data-screen-label="01 Hero" style={{
        ...
        <div className="container" style={{ paddingBlock: 120, position: "relative", zIndex: 1 }}>
          ...
          <p style={{
            ...
            Toughjobs is a Sacramento-based marketing agency for HVAC, plumbing, electrical and roofing
      ...
      <div style={{ position: "relative", height: "min(82vh, 760px)", minHeight: 560, overflow: "hidden" }}>
        ...
        <div className="container" style={{
          ...
          <p style={{
            ...
            contractors across Northern California.
          </p>
          <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
            <a className="btn" href="#">See the work</a>
...
function TrustMarquee() {
  const items = [
  "MIDTOWN HVAC", "ROSEVILLE PLUMBING CO.", "LINCOLN ELECTRIC SVC",
  "NATOMAS ROOFING", "FOLSOM AIR & HEAT", "TRACY MECHANICAL",
  "STOCKTON TRADES GROUP", "ELK GROVE GARAGE"];
...
function Services() {
  ...
  return (
    <section data-screen-label="02 Services" style={{ background: "#000000", color: "var(--white)" }} className="chev-bot">
      <div className="container">
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "end", marginBottom: 64 }}>
          ...
          <p style={{ fontSize: 17, lineHeight: 1.6, color: "rgba(255,255,255,.7)", maxWidth: 480, marginLeft: "auto" }}>
            Most agencies sell you one of these and call it done. We run all four together because that's
            the only way the math actually works for a trades business.
          </p>
        </div>
        <div style={{
          display: "grid",
          ...
          gap: 1,
          background: "rgba(255,255,255,.08)", /* acts as the hairline grid */
...
function Wraps() {
  ...
  return (
    <section data-screen-label="03 Wraps" style={{ background:"var(--surface)", position:"relative" }} className="chev-bot">
      <div className="container">
        ...
        {/* Wrap-format strip: featured truck on the left, trailer + sedan stacked on the right */}
        <div style={{ display:"grid", gridTemplateColumns:"1.4fr 1fr", gap:16, alignItems:"stretch" }}>
          <WrapTile label={tiles[0].label} format="Service truck" badge="01" cover="assets/wrap-truck-erik.png" />
          <div style={{ display:"grid", gridTemplateRows:"1fr 1fr", gap:16 }}>
            <WrapTile label={tiles[1].label} format="Trailer" badge="02" cover="assets/wrap-trailer-guacnroll.png" compact />
...
function Statement() {
  return (
    <section data-screen-label="04 Statement" style={{
      background: "var(--accent)",
...
const CITY_DATA = [
  ["Sacramento", 0], ["Roseville", 18], ["Elk Grove", 14], ["Folsom", 22],
  ["Lincoln", 28], ["Natomas", 7], ["Midtown", 2], ["Tracy", 58],
  ["Stockton", 49], ["Davis", 15], ["Citrus Heights", 16], ["Rancho Cordova", 11]
];

function ServiceArea({ cityStyle = "stamp" }) {
  // Pick the tile component once, not per-iteration — keeps the map clean
  // and lets each variant control its own layout decisions (gap, borders…).
  const Tile = ({
    sweep: SweepTile, stamp: StampTile, pin: PinTile, slash: SlashTile
  })[cityStyle] || StampTile;

  // The stamp variant looks better as a borderless gap grid; the others
  // share the 3-col hairline cage.
  ...
  return (
    <section data-screen-label="05 Service area" style={{ background: "var(--surface)" }} className="chev-bot">
      <div className="container" style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: 80, alignItems: "start" }}>
        <div>
          ...
          <h2 className="display split" style={{ fontSize: "clamp(40px, 5vw, 72px)", margin: "16px 0 24px" }}>
            <span className="a">Northern</span><br />
            <span className="b">California.</span><br />
            <span className="m">Boots on the ground.</span>
          </h2>
          <p style={{ fontSize: 17, lineHeight: 1.6, color: "var(--smoke)", maxWidth: 440, margin: "0 0 24px" }}>
            We meet clients on job sites and tailgates, not Zoom calls. If you're inside the I-80 corridor,
    ...
    <a href="#"
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 2 }}>
        ...
        <span style={{
          ...
          {distance === 0 ? "HQ" : `${distance} MI · I-80`}
        </span>
      </div>
    </a>
  );
...
function Insights() {
  const cards = [
  { tag: "Field guide", title: "Why your Google Business Profile is doing 60% of your SEO work", read: "6 min read", cover: "assets/insight-field-guide.png" },
  { tag: "Teardown", title: "The 4 reasons a $4K WordPress site outperforms a $40K custom build", read: "9 min read", cover: "assets/insight-teardown.png" },
...
function CtaBand() {
  return (
    <section id="contact" data-screen-label="07 CTA" style={{ background: "var(--accent)", paddingBlock: 120, position: "relative" }} className="chev-top">
    ...
    <footer data-screen-label="08 Footer" style={{ background: "var(--ink)", color: "var(--white)", paddingBlock: 80 }}>
      <div className="container">
        <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr 1fr", gap: 48, marginBottom: 64 }}>
          ...
          { h: "Visit", l: ["5 Crevalle Pl", "Sacramento, CA 95835", "(309) 741-4599", "hello@toughjobs.com"] }].
          map((col) =>
          <div key={col.h}>
